...
**Activating phase:** Phase 12 (see `docs/phases/` and `docs/MODULE_ROADMAP.md`).
...
- `FINANCE_SPEC.md` — purpose, business owner, users, entities, database
  ...
  criteria
- `FINANCE_WORKFLOW.md`
- `FINANCE_PERMISSION_MATRIX.md`
- `FINANCE_AUDIT_EVENTS.md`
- `FINANCE_TEST_PLAN.md`
