...
**Purpose:** Private file storage foundation.
...
- `STORAGE_SPEC.md` — purpose, business owner, users, entities, database
  ...
  criteria
- `STORAGE_WORKFLOW.md`
- `STORAGE_PERMISSION_MATRIX.md`
- `STORAGE_AUDIT_EVENTS.md`
