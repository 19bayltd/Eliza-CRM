...
**Purpose:** Reporting platform.

**Activating phase:** Phase 13 (see `docs/phases/` and `docs/MODULE_ROADMAP.md`).
...
- `REPORTING_SPEC.md` — purpose, business owner, users, entities, database
...
- `REPORTING_PERMISSION_MATRIX.md`
- `REPORTING_AUDIT_EVENTS.md`
- `REPORTING_TEST_PLAN.md`
