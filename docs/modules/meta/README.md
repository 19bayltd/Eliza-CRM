...
**Purpose:** Meta advertising reporting.

**Activating phase:** Phase 15 (see `docs/phases/` and `docs/MODULE_ROADMAP.md`).
...
- `META_SPEC.md` — purpose, business owner, users, entities, database
  ...
  criteria
- `META_WORKFLOW.md`
- `META_PERMISSION_MATRIX.md`
- `META_AUDIT_EVENTS.md`
- `META_TEST_PLAN.md`
