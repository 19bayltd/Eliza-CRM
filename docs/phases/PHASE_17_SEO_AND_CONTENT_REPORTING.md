# Phase 17 — SEO and Content Reporting
...
Import and report SEO and website performance (rankings, traffic, content output) with traceability.

## Business Outcome

SEO/website trends are visible with sources, date ranges, and freshness — no invented numbers.

## Included Scope

- SEO/website data imports (Search Console/analytics exports; CSV first), master §18 pipeline
- Keyword/page metric storage with source identifiers
- Content-output tracking
- SEO report views on the Phase 13 platform

## Excluded Scope

- Live analytics API integrations (Phase 20)
...
SEO metric tables; idempotent imports.
...
SEO report view/import permissions.
